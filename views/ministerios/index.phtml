...
<table class="ui table segment" id="tabelaListagem" style="width:auto;">
  ...
  <?php //} ?>
      ...
      $listagem .= "<tr>";
        ...
        $listagem .= "<td><div class=\"mini ui teal labeled icon button balao\" data-content='Editar Integrantes' onClick=\"editarBt('".$campos['id']."', 'integrantes/intgrt')\"><i class=\"pencil icon\"></i> Integrantes</div></td>";
        $listagem .= "<td>
...
<?php 
  ...
  */
    ...
    foreach ($dados['itens'] as $chave => $campos)
      $dados['itens'][$chave]['botao'] = "<div class=\"mini ui teal labeled icon button balao\" data-content=\"Editar Integrantes\" onClick=\"editarBt('".$dados['itens'][$chave]['id']."', 'integrantes/intgrt')\"><i class=\"pencil icon\"></i> Integrantes</div>";
  ...
  function botao($id){
    return "<div class=\"mini ui teal labeled icon button balao\" data-content='Editar Integrantes' onClick='editarBt('$id', 'integrantes/')'><i class=\"pencil icon\"></i> Integrantes</div>";
  }
?>
